...
const curriculumItems = [
  {
    ...
    description: "Pengantar konsep matematika dasar",
    category: "Matematika",
    updated: "25 Jun 2025, 09:00 WIB",
    cover: "https://via.placeholder.com/150x200/000000/FFFFFF?text=Math",
  },
  {
    id: 2,
    title: "Sejarah Indonesia",
    description: "Sejarah perkembangan Indonesia",
    category: "Sejarah",
    updated: "26 Jun 2025, 14:30 WIB",
    cover: "https://via.placeholder.com/150x200/000000/FFFFFF?text=History",
  },
  {
    id: 3,
    title: "Fisika Modern",
    description: "Dasar-dasar fisika kontemporer",
    category: "Sains",
    updated: "27 Jun 2025, 11:15 WIB",
    cover: "https://via.placeholder.com/150x200/000000/FFFFFF?text=Physics",
  },
  {
    id: 4,
    title: "Bahasa Indonesia",
    description: "Pembelajaran tata bahasa dan sastra",
    category: "Bahasa",
    updated: "24 Jun 2025, 16:45 WIB",
    cover: "https://via.placeholder.com/150x200/000000/FFFFFF?text=Bahasa",
  },
];
...
export default function Curriculum() {
  ...
  const categories = ["all", "Matematika", "Sejarah", "Sains", "Bahasa"];
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mt-1">
                {curriculumItems.length} mata pelajaran tersedia
              </p>
            </div>
          </div>
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <div className="mt-4">
                          <button
                            onClick={() =>
                              console.log(`Memulai proses untuk ${item.title}`)
                            }
